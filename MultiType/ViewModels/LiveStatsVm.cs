...
namespace MultiType.ViewModels
{
    ...
    class LiveStatsVm : BaseVm
	{
        ...
        public LiveStatsVm(string lessonString, RichTextBox userInput, SocketsAPI.AsyncTcpClient socket = null, bool isServer = false, int racerSpeed = 0)
        {
            //if (socket == null)
            //{
